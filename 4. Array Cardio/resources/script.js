...
const XV = inventors.filter(inventor => inventor.year >= 1500 && inventor.year < 1600);
console.table(XV);
...
// more scalable way
  const age = inventors.sort((a,b) => {
    currentAge = a.passed - a.year;
    nextAge = b.passed - b.year;
...
const lastName = people.sort((current,next) => {
...
const number = data.reduce((total,data) =>{
